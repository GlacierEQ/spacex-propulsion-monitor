"""
Mastermind Sidecar — spacex-propulsion-monitor
...
class MastermindSidecar:
    ...
    def __init__(self, repo_name: str = "spacex-propulsion-monitor"):
        self.repo_name = repo_name
        self.start_time = time.time()
        self.health_cache: Dict[str, Any] = {}
        self._modules = [raptor_health, engine_controller, predictive_health]
